...
public class WhyLate2 {
	public final static int PARTITIONS_PER_INSTANCE =5;
...
//			System.out.println("partition:"+partition);
		...
		public String toString() {
			return "Event{" + "userId=" + userId + ", partition=" + partition + ", @" + timestamp + '}'+stampToDate(timestamp);
		}
	}
...
//					running=false;
	...
	private static class CountEventsPerUser extends ProcessWindowFunction<Event, Tuple2<String, Integer>, String, TimeWindow> {
		...
		public void process(
			...
			System.err.println("=======================CountEventsPerUser=======================");
	...
	private static class CountLateEvents extends ProcessAllWindowFunction<Event, Integer, TimeWindow> {
		...
		public void process(
			...
			System.err.println("=======================CountLateEvents=======================");
			for(Event e:iterable) {
				System.err.println(e);
			}
			System.err.println("=======================CountLateEvents=======================");
